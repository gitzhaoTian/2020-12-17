...
//        GeocodeQuery query1 = new GeocodeQuery(et_first.getText().toString(), "");
//        geocodeSearch.getFromLocationNameAsyn(query1);
    ...
    private void searsh() {
        search = new GeocodeSearch(MainActivity.this);
        ...
        GeocodeQuery query1 = new GeocodeQuery(et_end.getText().toString(), "");
        geocodeSearch.getFromLocationNameAsyn(query1);
    }
